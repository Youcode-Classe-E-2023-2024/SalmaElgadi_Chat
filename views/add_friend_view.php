...
<div class="fixed w-full bg-white flex overflow-hidden" style="height: 200vh;"> 
  ...
  <!-- Sidebar -->
    ...
    <main class="max-w-full ml-24 h-full flex flex-col gap-5 py-24 relative overflow-y-hidden">
    ...
    <div class=" m-4 flex flex-wrap gap-10 items-start justify-start rounded-tl grid-flow-col ">
        ...
        <div class="flex w-full mx-10 rounded bg-white">
            <input class=" w-full border-none bg-blue-100 px-4 py-1 text-gray-400 outline-none focus:outline-none " type="search" id="searchInput" placeholder="Search..." />
        ...
        ?>
        <section class="w-96 mx-auto bg-[#20354b] rounded-2xl px-8 flex flex-col justify-center py-6 shadow-lg">
