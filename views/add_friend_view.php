...
<div class="w-full bg-white relative flex overflow-hidden" style="height: 200vh;">
  ...
  <aside class="h-full w-16 flex flex-col space-y-10 pt-20 items-center gap-8 relative bg-gray-800 text-white">
    ...
    <div class=" m-4 flex flex-wrap items-start justify-start rounded-tl grid-flow-col ">
        
        <!-- search friends -->
        <div class="flex w-full mx-10 rounded bg-white">
            <input class=" w-full border-none bg-blue-100 px-4 py-1 text-gray-400 outline-none focus:outline-none " type="search" name="search" placeholder="Search..." />
